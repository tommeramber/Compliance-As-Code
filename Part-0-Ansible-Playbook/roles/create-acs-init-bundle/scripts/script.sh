...
roxctl -e "$ROX_CENTRAL_ADDRESS"   central init-bundles generate test   --output ../Part-2-Compliance-as-GitOps/policies/acs-policies/files/init_bundle.yaml --insecure-skip-tls-verify --password $PASS
...
sed  "/sensor-key.pem/i  \ \ acs-host: $ACS_HOST" ../Part-2-Compliance-as-GitOps/policies/acs-policies/files/init-bundle.yaml  -i


csplit ../Part-2-Compliance-as-GitOps/policies/acs-policies/files/init-bundle.yaml '/^---$/' '{*}' 
